...
if __name__ == '__main__':
    ...
    for i, (_) in enumerate(tqdm([i for i in range(2216)])):
        ...
        topK_index_jaccard = finding_topK_jaccard(diff_trains=train_diff_new, diff_test=test_diff[i], topK=1)
    ...
    with open('nearest_diff_topk_20cos_1jac.csv', 'w', newline='') as f:
        writer = csv.writer(f)
